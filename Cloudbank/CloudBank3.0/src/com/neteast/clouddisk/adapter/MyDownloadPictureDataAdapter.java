...
public class MyDownloadPictureDataAdapter  extends BaseAdapter{
	...
	private int mPage = -1;
	// 每页显示的Item个数
	public static final int SIZE = Params.MYDOWNLOAD_PICTURE_PER_PAGE_NUM;
	private ImageDownloader2 mImageDownloader2;
	public MyDownloadPictureDataAdapter(Context context, List<DataInfo> result,int page,View.OnLongClickListener mLongClickListener,View.OnClickListener mClickListener) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView == null){
			convertView = LayoutInflater.from(context).inflate(
					R.layout.mydownloadpictureelementlayout, null);
		}
