...
public class MyUploadVideoDataAdapter  extends BaseAdapter{
	...
	public MyUploadVideoDataAdapter(Context context, List<DataInfo> result,int page,View.OnLongClickListener mLongClickListener,View.OnClickListener mClickListener) {
