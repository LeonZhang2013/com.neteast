...
public class MyUploadFileDataAdapter  extends BaseAdapter{
	...
	public MyUploadFileDataAdapter(Context context, List<DataInfo> result,int page,View.OnLongClickListener mLongClickListener,View.OnClickListener mClickListener) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		convertView = LayoutInflater.from(context).inflate(
				R.layout.myuploadfileelementlayout, null);
