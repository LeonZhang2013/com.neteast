package com.neteast.clouddisk.videoview;
...
public class VideoView extends SurfaceView implements MediaPlayerControl {
    ...
    private void openVideo() {
        ...
        Intent i = new Intent("com.neteast.music.musicservicecommand");
...
/*                if (framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
    ...
    /**
     * Register a callback on Buffering 
    ...
    public void start() {
        if (mMediaPlayer != null && mIsPrepared) {
        		Log.d("VideoView start", " isPlaying = " + mMediaPlayer.isPlaying());
                mMediaPlayer.start();
                mStartWhenPrepared = false;
        } else {
    ...
    public void pause() {
        if (mMediaPlayer != null && mIsPrepared) {
        	Log.d("VideoView pause", " isPlaying = " + mMediaPlayer.isPlaying());
            if (mMediaPlayer.isPlaying()) {
                mMediaPlayer.pause();
            }
        }
