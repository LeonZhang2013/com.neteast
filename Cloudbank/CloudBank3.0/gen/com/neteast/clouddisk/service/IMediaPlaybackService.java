 ...
 * Original file: D:\\github\\cloudbank\\CloudBank3.0\\src\\com\\neteast\\clouddisk\\service\\IMediaPlaybackService.aidl
 */
package com.neteast.clouddisk.service;
public interface IMediaPlaybackService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.neteast.clouddisk.service.IMediaPlaybackService
{
private static final java.lang.String DESCRIPTOR = "com.neteast.clouddisk.service.IMediaPlaybackService";
...
/**
 * Cast an IBinder object into an com.neteast.clouddisk.service.IMediaPlaybackService interface,
 * generating a proxy if needed.
 */
public static com.neteast.clouddisk.service.IMediaPlaybackService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.neteast.clouddisk.service.IMediaPlaybackService))) {
return ((com.neteast.clouddisk.service.IMediaPlaybackService)iin);
}
return new com.neteast.clouddisk.service.IMediaPlaybackService.Stub.Proxy(obj);
}
...
case TRANSACTION_createplaylist:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.createplaylist(_arg0);
reply.writeNoException();
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _result = this.getImage();
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
java.lang.String _arg0;
_arg0 = data.readString();
int _result = this.playById(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_removeById:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
int _result = this.removeById(_arg0);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
private static class Proxy implements com.neteast.clouddisk.service.IMediaPlaybackService
{
...
@Override public void createplaylist(int position) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(position);
mRemote.transact(Stub.TRANSACTION_createplaylist, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
@Override public java.lang.String getImage() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
@Override public int playById(java.lang.String id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
@Override public int removeById(java.lang.String id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(id);
mRemote.transact(Stub.TRANSACTION_removeById, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_createplaylist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
...
static final int TRANSACTION_getName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getImage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_enqueue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getQueue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
...
static final int TRANSACTION_playById = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_removeById = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
}
...
public void createplaylist(int position) throws android.os.RemoteException;
...
public java.lang.String getImage() throws android.os.RemoteException;
...
public int playById(java.lang.String id) throws android.os.RemoteException;
public int removeById(java.lang.String id) throws android.os.RemoteException;
}
