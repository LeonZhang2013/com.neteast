...
public class LogUtil {
    ...
    private static final File LOG_DIR=new File(Environment.getExternalStorageDirectory(), "HuaLong/log/");
    
    public final static String LOGTAG = "HuaLong";
    ...
    private static String getDividerLine() {
        SimpleDateFormat dividerLineFormat = new SimpleDateFormat("yyyy年MM月dd日 HH时mm分ss秒",Locale.CHINA);
    ...
    private static File getLogFile() {
        SimpleDateFormat fileNameFormat = new SimpleDateFormat("yyyy年MM月dd日 HH时",Locale.CHINA);
        Date date = new Date(System.currentTimeMillis());
