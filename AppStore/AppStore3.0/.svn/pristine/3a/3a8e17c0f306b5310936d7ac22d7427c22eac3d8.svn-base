...
public class FileCache {
	...
	/** 缓存子路径 */
	private String filedir = "neteast/appstore/imageCahe";
	/** 图片后缀名 */
	private final String imagerFlag = ".appstore";
	/**
	 * 创建缓存目录
	 * @param context
	 */
	...
	/**
	 * 当本地文件总大小超过 cacheMaxInByte，会删除长久没有使用的文件。
	 * @param cacheMaxInByte 允许保存的本地图片数量
	 */
