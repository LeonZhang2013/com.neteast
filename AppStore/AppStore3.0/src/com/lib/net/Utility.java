...
public class Utility {
	 ...
	 * @return UrlEncodedFormEntity: encoed entity */
	public static String openUrl(Context context, String url, WeiboParameters params, String method) {
		String result = "";
		try {
	...
	public static void setHeader(String httpMethod, HttpUriRequest request, WeiboParameters authParam, String url)
		...
		request.setHeader("User-Agent", System.getProperties().getProperty("http.agent") + " AndroidSDK");
	}
