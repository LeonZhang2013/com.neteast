...
public class MemoryCache {  
    ...
    public void del(String url){
    	final Bitmap bitmap = getBitmapFromCache(url,false);
    	if(bitmap != null && bitmap.isRecycled() == false){
    		bitmap.recycle();
    		//System.out.println("del hJheap:"+Runtime.getRuntime().totalMemory()+",Nheap:"+Debug.getNativeHeapAllocatedSize());
        }
    }
    ...
    public void clear(){
    	...
    	while(hIter.hasNext()){
             ...
             //System.out.println("hJheap:"+Runtime.getRuntime().totalMemory()+",Nheap:"+Debug.getNativeHeapAllocatedSize());
    	}
    	...
    	while(sIter.hasNext()){
            ...
            // System.out.println("sJheap:"+Runtime.getRuntime().totalMemory()+",Nheap:"+Debug.getNativeHeapAllocatedSize());
    	}
